...
Portal Launching
    ...
    # ${Delay}=     Set Variable    ${details}[TC_01][Scheduler]
    Open Browser         ${URL}       browser=Edge  executable_path=C:\\Users\\Q0041\\Documents\\Robots\\Manapuram\\msedgedriver.exe
...
MAIN FLOW
    ...
    Data Collection
    # Open Workbook       ${File}
    # ${data}=  Read Worksheet As Table  Sheet3  header=${True}
    # Close Workbook
    ${data}     Filtering Data
    FOR    ${element}    IN    @{data}
